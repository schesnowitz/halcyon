...
class DriverStatementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create driver_statement" do
    assert_difference('DriverStatement.count') do
      post driver_statements_url, params: { driver_statement: { driver_id: @driver_statement.driver_id, due_date: @driver_statement.due_date, paid: @driver_statement.paid } }
    end
  ...
  test "should update driver_statement" do
    patch driver_statement_url(@driver_statement), params: { driver_statement: { driver_id: @driver_statement.driver_id, due_date: @driver_statement.due_date, paid: @driver_statement.paid } }
